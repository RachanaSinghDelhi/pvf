<div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="text-primary"><img src="img/images/logo2.jpg" height="150" ></h1>
        ...
        <a href="team.php#ulema" class="dropdown-item">Ulema Team</a>
                    ...
                    <a href="membership.php" class="btn btn-primary rounded-pill py-2 px-4 my-3 my-lg-0 flex-shrink-0">Apply</a>
                </div>
            </nav>