        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-6 col-xl-4">
                <div class="footer-item">
                    <a href="index.php" class="p-0">
                        <h4 class="text-white"><i class="fas fa-hand-holding-heart me-3"></i>Pasmanda Vikas Foundation</h4>
                    </a>
                    <p class="mb-4">Pasmanda Vikas Foundation is dedicated to the upliftment and welfare of the Pasmanda community, including Muslim OBCs, SCs, and STs. We strive to ensure equality, justice, and development for all.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-xl-2">
                <div class="footer-item">
                    ...
                    <a href="services.php"><i class="fas fa-angle-right me-2"></i> Our Work</a>
