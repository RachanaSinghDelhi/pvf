                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="add_event.php" class="btn btn-primary">Add New Gallery Item</a>
                        </div>
                                    ...
                                    <?php if ($result->num_rows > 0): ?>
                                        <?php $i = 1; while ($event = $result->fetch_assoc()): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Edit Button -->
                                                    <a href="edit_gallery.php?id=<?= $event['id'] ?>" class="btn btn-sm btn-warning">Edit</a>

                                                    <!-- Delete Button -->
                                                   
                                                    <form class="delete-events-form" method="POST" style="display: inline;">
