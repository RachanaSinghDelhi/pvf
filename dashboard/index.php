    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="create_member.php" class="btn btn-primary">Add New Member</a>
            </div>
                            ...
                            <?php $i = 1; while ($member = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <img src="images/default-avatar.png" alt="Default Avatar" style="width: 50px; height: auto; border-radius: 50%;">
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <!-- Edit Button -->
                                        ...
                                        <?php if (!$member['is_approved']): ?>
                                            <form action="approve_member.php" method="POST" style="display: inline;">
